        ...
        let stored = store
            .put_msg_secrets(vec![
                MsgSecretEntry {
                    ...
                    sender: "s".into(),
                    msg_id: "M1".into(),
                    secret: Box::new([1u8; wacore::reporting_token::MESSAGE_SECRET_SIZE]),
                    expires_at: 0,
                    message_ts: 0,
                },
                MsgSecretEntry {
                    ...
                    sender: "s".into(),
                    msg_id: "M2".into(),
                    secret: Box::new([2u8; wacore::reporting_token::MESSAGE_SECRET_SIZE]),
                    expires_at: 0,
                    message_ts: 0,
                },
                MsgSecretEntry {
                    ...
                    sender: "s".into(),
                    msg_id: "M1".into(),
                    secret: Box::new([9u8; wacore::reporting_token::MESSAGE_SECRET_SIZE]),
                    expires_at: 0,
                    message_ts: 0,
                },
            ])
        ...
        store
            .put_msg_secrets(vec![
                ...
                MsgSecretEntry {
                    ...
                    sender: "s".into(),
                    msg_id: "PAST".into(),
                    secret: Box::new([3u8; wacore::reporting_token::MESSAGE_SECRET_SIZE]),
                    expires_at: now - 86_400,
                    message_ts: 0,
                },
            ])
    ...
    async fn get_msg_secret_with_ts_round_trips_and_keeps_parent_ts() {
        ...
        store
            .put_msg_secrets(vec![MsgSecretEntry {
                ...
                sender: "s".into(),
                msg_id: "M".into(),
                secret: Box::new([5u8; wacore::reporting_token::MESSAGE_SECRET_SIZE]),
                expires_at: 0,
