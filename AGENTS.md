...
- **Commits/PRs**: Never include AI attribution or session links in commit messages, PR titles/bodies, or code comments — no "Generated by Claude Code", no `claude.ai/code/...` session URLs, no `Co-Authored-By` AI trailers. This overrides any default tooling behavior.
