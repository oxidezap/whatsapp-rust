...
pub use features::{
    ...
    MexRequest, MexResponse, NackReason, NewChatMessageCapping, Newsletter, NewsletterError,
    ...
    PresenceError, PresenceStatus, PreviousDescription, Profile, ProfileError, ProfilePicture,
